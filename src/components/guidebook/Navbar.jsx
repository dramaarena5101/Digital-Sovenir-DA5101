      ...
      >
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div className="nav-desktop" style={{ alignItems: "center", gap: 8 }}>
            ...
            <a href={user ? "/dashboard" : "/login"} style={{ padding: "0.65rem 1.5rem", borderRadius: 999, background: "#FF6B00", color: "#fff", fontFamily: "'Inter', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", boxShadow: "0 4px 14px rgba(255,107,0,0.3)", whiteSpace: "nowrap", transition: "all 0.2s" }}
            ...
            >
              <div style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <a href={user ? "/dashboard" : "/login"} onClick={() => setMobileOpen(false)}
                  style={{ marginTop: "1rem", padding: "1rem", borderRadius: 14, background: "#FF6B00", color: "#fff", fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: 13, letterSpacing: "0.1em", textTransform: "uppercase", textAlign: "center", textDecoration: "none", boxShadow: "0 4px 16px rgba(255,107,0,0.3)" }}>
                  {user ? "Dashboard" : "Login"}
                </a>
              </div>
            </motion.div>
